...
其中:$x$表示所在图像坐标，$y(x)$属于真实信号，$z(x)$属于相机最终观测到的信号,$\sigma()$表征噪声的标准差。我们将曝光时间内光子打在相机sensor上这个过程的不确定性建模为泊松分布，产生的噪声称泊松噪声项;将由于热噪声，读取噪声等剩余影响较小的噪声
...
======
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTI0ODA5NzQsLTE1MjIzMDc0OTIsMT
EwNzU4NDk5NV19
-->