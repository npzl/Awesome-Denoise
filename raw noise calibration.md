...
&ensp;&ensp;&ensp;&ensp;$\eta_p$是泊松项噪声，与信号强度$y(x)$相关，$\eta_g$是高斯项噪声。泊松分布特性：期望等于方差，且$P(\lambda)\approx{N(\lambda, \lambda)}$。由于相机成像量子效率泊松分布是放缩的,即。
...
======
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzMyMzQzNDU2LC0xNTIyMzA3NDkyLDExMD
c1ODQ5OTVdfQ==
-->