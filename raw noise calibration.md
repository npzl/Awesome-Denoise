...
&ensp;&ensp;&ensp;&ensp;实验表明，所成图像的噪声主要与相机拍摄时设置的模拟增益有关(数字增益的本质是直接乘上一个系数，其影响暂时不谈)，环境色温，曝光时间，环境温度的影响基本忽略不计。主要标定的方法简单的来说就是通过
(1)泊松噪声标定    
_______________   
...
======
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTczNTY1NTcxNCwtMTEyNzI0NDE0MywyMT
Q3MTQxNzAzXX0=
-->